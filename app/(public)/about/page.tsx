...
export const metadata: Metadata = {
  ...
  description:
    'Learn about Alok Ranjan Paramedical Institute (ARPI), Gaya — our history, mission, vision, director message and commitment to healthcare education.',
  ...
  const tabs = [
    {
      ...
      content: (
        <div className="grid items-center gap-8 md:grid-cols-2">
          ...
          <div className="overflow-hidden rounded-xl border border-border">
            <SafeImage
              src={getBackendImageUrl('/uploads/general/campus-building.png')}
